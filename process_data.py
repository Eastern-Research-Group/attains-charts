...
with open('json/parameters.json') as pfile:
    parameters = json.load(pfile)
parameterDict = {}
for p in parameters:
    parameterDict[p['name']] = p['context']
pfile.close()
# print(parameterDict)
    ...
    # if filename == 'CA.json':
        ...
        for item in tmdls['items']:
            for action in item['actions']:
                ...
                # print(action['TMDLReportDetails']['TMDLDate'])
                for au in action['associatedWaters']['specificWaters']:
                    ...
                    for pollutant in au['associatedPollutants']:
                        ...
                        tmdlList.append({'FiscalYear': get_fiscal_year(action['TMDLReportDetails']['TMDLDate']),
